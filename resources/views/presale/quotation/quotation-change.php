    ...
    <nav>
      <div class="container">
        <div class="nav-wrapper">
          ...
          <a href="#!" class="breadcrumb">Change Quotation</a>
        ...
        <div class="col s9 m9 l9 xl9" style="margin-top: 15px;">
          <div class="card">
            <div class="card-content">
              <h4 style="margin-bottom: 50px">Change Quotation</h4>
              <form action="">
                <div class="row">
          ...
          <div class="card" style="margin-bottom:75px">
            <div class="card-content">
              <div class="row">
                <div class="col s12">
                  <h4 style="margin-bottom: 50px">All Quotation</h4>
                  ...
                  <table class="highlight">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Thailand</td>
                        <td>CNX00</td>
                        <td><a href="customer-change-result.php" class="waves-effect waves-light btn">Details</a></td>
                      </tr>
                      <tr>
                        <td>College of arts media and technology,inc</td>
                        <td>Chiangmai</td>
