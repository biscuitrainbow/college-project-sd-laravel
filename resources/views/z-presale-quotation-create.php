    ...
    <nav>
      <div class="container">
        <div class="nav-wrapper">
          <a href="main.php" class="breadcrumb">Sale and Distribution</a>
        ...
        <div class="col s9 m9 l9 xl9" style="margin-top: 15px;">
          <div class="card">
            <div class="card-content">
              <h4 style="margin-bottom: 50px">Create Inquiry</h4>
              <form action="">
                ...
                <!-- Submit Button -->
                <div class="row">
                  <div class="col s12" style="text-align: right;"><a class="waves-effect waves-light btn">Submit</a></div>
                </div>
              </form>
            </div>
          </div>
