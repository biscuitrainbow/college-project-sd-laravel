    ...
    <nav>
      <div class="container">
        <div class="nav-wrapper">
          ...
          <a href="#!" class="breadcrumb">Display Invoice</a>
        ...
        <div class="col s9 m9 l9 xl9" style="margin-top: 15px;">
          <div class="card">
            <div class="card-content">
              <h4 style="margin-bottom: 50px">Display Invoice</h4>
              <form action="">
                <div class="row">
          ...
          <div class="card" style="margin-bottom:75px">
            <div class="card-content">
              <div class="row">
                <div class="col s12">
                  <h4 style="margin-bottom: 50px">All Receipt</h4>
                  ...
                  <table class="highlight">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Check Note</td>
                        <td>16/04/2017</td>
                        <td><a href="invoice-display-result.php" class="waves-effect waves-light btn">Details</a></td>
                      </tr>
                      <tr>
                        <td>I000001</td>
                        <td>S000010</td>
