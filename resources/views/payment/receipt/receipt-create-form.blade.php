...
@endsection
@section('content')
    <h4 class="main-title">Create Receipt</h4>
    <form action="{{route('storeReceipt')}}" method="post">
        ...
        <div class="row">
            <div class="input-field col s4">
                <input disabled id="compy_name" type="text" value="{{$invoice[0]->company_name}}">
                <label>Customer</label>
            </div>
            <div class="input-field col s4">
                <input disabled type="text" value="{{$invoice[0]->created_at}}">
                <label>Create Date</label>
            </div>
            <div class="input-field col s4">
                <input disabled id="request_date" type="text" value="{{$invoice[0]->request_date}}">
