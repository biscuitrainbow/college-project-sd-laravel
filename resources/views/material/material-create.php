    ...
    <nav>
      <div class="container">
        <div class="nav-wrapper">
          ...
          <a href="#!" class="breadcrumb">Create Material</a>
            ...
            <div class="card-content">
              ...
              <form action="">
                ...
                <div class="row">
                  ...
                  <div class="input-field col s4">
                    <input id="product_quantity" type="text" class="validate">
                ...
                <div class="row">
                  ...
                  <div class="input-field col s6">
                    <input id="product_categories" type="text" class="validate">
                ...
                <!-- Submit Button -->
                <div class="row">
                  <div class="col s12" style="text-align: right;"><a class="waves-effect waves-light btn">Create Material Document</a></div>
                </div>
              </form>
            </div>
          </div>
